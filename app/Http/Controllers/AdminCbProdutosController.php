<?php namespace App\Http\Controllers;
	...
	class AdminCbProdutosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Material","name"=>"material","join"=>"cb_produtos_material,nome"];
			$this->col[] = ["label"=>"Cor","name"=>"cor"];
			$this->col[] = ["label"=>"Modelo","name"=>"modelo","join"=>"cb_produtos_modelo,nome"];
			$this->col[] = ["label"=>"Acabamento","name"=>"acabamento","join"=>"cb_produtos_acabamento,nome"];
			$this->col[] = ["label"=>"Custo","name"=>"precoCusto","callback_php"=>'"R$ ".$row->precoCusto'];
			$this->col[] = ["label"=>"Atacado","name"=>"precoVendaAtacado","callback_php"=>'"R$ ".$row->precoVendaAtacado'];
			$this->col[] = ["label"=>"Varejo","name"=>"precoVendaVarejo","callback_php"=>'"R$ ".$row->precoVendaVarejo'];
			$this->col[] = ["label"=>"Foto","name"=>"foto","image"=>true];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Codigo','name'=>'codigo','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			...
			$this->form[] = ['label'=>'Genero','name'=>'genero','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'F|Feminino;M|Masculino;U|Unissex'];
			$this->form[] = ['label'=>'Material','name'=>'material','type'=>'select','width'=>'col-sm-5','datatable'=>'cb_produtos_material,nome'];
