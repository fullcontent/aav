...
<input type="text" placeholder="Digite o nome do produto" name="q" title="Enter to search" value="<?php echo e(Request::get('q')); ?>" class="form-control">
</form>
...
<tbody>
	...
	<tr>	
		...
		?>
		<td><a class='btn btn-primary' href='javascript:void(0)' onclick='parent.selectAdditionalData<?php echo e($name); ?>(<?php echo json_encode($select_data_result); ?>)'><i class='fa fa-check-circle'></i> Selecionar</a></td>
	</tr>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
</table>
